                                ...
                                <div class="portfolio-details-slider swiper init-swiper">
                                    ...
                                    <div class="swiper-wrapper align-items-center">
                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/Login.png') }}" alt="">
                                        </div>

                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/Dashboard.png') }}" alt="">
                                        </div>

                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/All-users.png') }}" alt="">
                                        </div>

                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/Jobs.png') }}" alt="">
                                        </div>

                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/Completed-Jobs.png') }}" alt="">
                                        </div>

                                        <div class="swiper-slide">
                                            <img src="{{ asset('laura/assets/img/portfolio/agenius/AppliedUserDetail.png') }}" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Project date</strong>: 05 August, 2023</li>
                                        <li><strong>Project URL</strong>: <a href="https://ageniushealthcare.com" target="_blank">https://ageniushealthcare.com</a></li>
                                    </ul>
                                </div>
                                <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
                                    <h2>Agenius &amp; Healthcare Staffing</h2>
                                    <p>
