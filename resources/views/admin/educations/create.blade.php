<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="degree" name="degree" class="form-control" placeholder="Degree: Bachelors/Masters" autofocus />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="university" name="university" class="form-control" placeholder="University/Board/School" />
