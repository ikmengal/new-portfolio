...
<div class="row">
    <div class="col-12 col-md-12 mb-3">
        ...
        <textarea class="form-control" rows="5" name="description" id="description" placeholder="Enter description">{{ $model->description ?? old('description') }}</textarea>
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="category" name="category" class="form-control" placeholder="Category: Web, App" value="{{ $model->category ?? '' }}" />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="client_name" name="client_name" class="form-control" placeholder="Client Name" value="{{ $model->client_name ?? '' }}" />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="project_url" name="project_url" class="form-control" placeholder="Project Url" value="{{ $model->project_url ?? '' }}" />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="date" id="start_date" name="start_date" class="form-control" placeholder="Start Date" value="{{ $model->start_date ?? '' }}" />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="date" id="end_date" name="end_date" class="form-control" placeholder="End Date" value="{{ $model->end_date ?? '' }}" />
...
<div class="row">
    <div class="col-md-12 mt-2">
        ...
        <select class="form-control form-select select2" name="status" id="status">
            ...
            <option value="Pending" {{ isset($model->status) && $model->status == "Pending" ? 'selected' : '' }} > Pending </option>
            <option value="Working" {{ isset($model->status) && $model->status == "Working" ? 'selected' : '' }} > Working </option>
            <option value="Completed" {{ isset($model->status) && $model->status == "Completed" ? 'selected' : '' }} > Completed </option>
        </select>
