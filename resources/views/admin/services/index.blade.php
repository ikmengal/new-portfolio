...
@section('content')
    @if(request()->is('service/trashed'))
        <input type="hidden" id="page_url" value="{{ route('service.trashed') }}">
    @else
    ...
    <div class="card mb-4">
        <div class="row">
            ...
            {{-- @canany(['services-create','services-trashed', 'services-list']) --}}
                <div class="col-md-6">
                    @if(request()->is('service/trashed'))
                        {{-- @can('services-list') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Records" href="{{ route('service.index') }}" class="btn btn-success btn-primary mx-3">
                                    <span>
                    ...
                    @else
                        <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                            {{-- @can('services-create') --}}
                                <button
                                    ...
                                    data-create-url="{{ route('service.create') }}"
                        ...
                        {{-- @can('services-trashed') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Trashed Records" href="{{ route('service.trashed') }}" class="btn btn-label-danger mx-1">
                                    <span>
