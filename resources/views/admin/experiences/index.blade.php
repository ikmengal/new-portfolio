...
@section('content')
    ...
    @else
        <input type="hidden" id="page_url" value="{{ route('experiences.index') }}">
    @endif
    <div class="card mb-4">
        <div class="row">
            <div class="col-md-6">
            ...
            {{-- @canany(['experiences-create','experiences-trashed', 'experiences-list']) --}}
                <div class="col-md-6">
                    @if(request()->is('experiences/trashed'))
                        {{-- @can('experiences-list') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Records" href="{{ route('experiences.index') }}" class="btn btn-success btn-primary mx-3">
                                    <span>
                        ...
                        <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                            {{-- @can('experiences-create') --}}
                                <button
                                    ...
                                    data-url="{{ route('experiences.store') }}"
                                    data-create-url="{{ route('experiences.create') }}"
                                    ...
                                    <span>
                                        ...
                                        <span class="d-none d-sm-inline-block"> Add Experience </span>
                                    </span>
                                </button>
                            {{-- @endcan --}}
                        </div>
                        {{-- @can('experiences-trashed') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Trashed Records" href="{{ route('experiences.trashed') }}" class="btn btn-label-danger mx-1">
                                    <span>
                ...
                <div class="modal-content p-3 p-md-5">
                    ...
                    <div class="modal-body">
                        <div class="text-center mb-4">
                            <h3 class="mb-2" id="modal-label">Add Experience</h3>
                        </div>
