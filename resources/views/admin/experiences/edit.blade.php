...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="title" name="title" class="form-control" placeholder="Title: Manager" value="{{ $model->title ?? '' }}" autofocus />
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" id="company" name="company" class="form-control" placeholder="company: Ibex" value="{{ $model->company ?? '' }}" />
