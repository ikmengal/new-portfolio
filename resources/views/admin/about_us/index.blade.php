...
@section('content')
    @if(request()->is('about_us/trashed'))
        <input type="hidden" id="page_url" value="{{ route('about_us.trashed') }}">
    @else
    ...
    <div class="card mb-4">
        <div class="row">
            ...
            {{-- @canany(['about_us-create','about_us-trashed', 'about_us-list']) --}}
                <div class="col-md-6">
                    @if(request()->is('about_us/trashed'))
                        {{-- @can('about_us-list') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Records" href="{{ route('about_us.index') }}" class="btn btn-success btn-primary mx-3">
                                    <span>
                        ...
                        <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                            {{-- @can('about_us-create') --}}
                                <button
                                    ...
                                    data-url="{{ route('about_us.store') }}"
                                    data-create-url="{{ route('about_us.create') }}"
                                    ...
                                    <span>
                                        ...
                                        <span class="d-none d-sm-inline-block"> Add About Us </span>
                                    </span>
                                </button>
                            {{-- @endcan --}}
                        </div>
                        {{-- @can('about_us-trashed') --}}
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                <a data-toggle="tooltip" data-placement="top" title="View ALl Trashed Records" href="{{ route('about_us.trashed') }}" class="btn btn-label-danger mx-1">
                                    <span>
                ...
                <div class="modal-content p-3 p-md-5">
                    ...
                    <div class="modal-body">
                        <div class="text-center mb-4">
                            <h3 class="mb-2" id="modal-label">Add About Us</h3>
                        </div>
